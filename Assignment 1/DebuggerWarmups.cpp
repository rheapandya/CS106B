 ...
 *
 * Q1:
 *It once came to pass that abstract expressionist painter Lee Krasner
 *was running a high-altitude marathon when, without warning, Rhea Pandya
 *saved the Leshan Giant Buddha from a plague of locusts for the second time
 *in a week. THE END!
 *
 *
 *
 * Q2:
 *compiling ../../DebuggerWarmups.cpp
../../DebuggerWarmups.cpp:255:38: warning: all paths through this function will call itself [-Winfinite-recursion]
 ...
 *
 * Q3:
 *980, 184, 662, 343, 911, 170, 502, 980
 *
 *
 *
 */
 ...
 */
const string MyName = "Rhea Pandya";
